...
if __name__ == '__main__':
    ...
    ap.add_argument('--indir', '-i', nargs='?', default='../InstanceSegmentationResult/ROI2_Feb25Sun_2018_001348/WatershedSegmentationImages', help='Specify input files (format : csv)')
    ...
    with open(opbase + psep + 'result.txt', 'a') as f:
        for t in t_list:
            ...
            gt = io.imread('../images/instance_segmentation_gt/gt_t{}.tif'.format(t))
