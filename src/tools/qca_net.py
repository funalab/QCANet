...
def main():
    ...
    ap.add_argument('--model_nsn', '-ms', nargs='?', default='models/p128/learned_nsn.npz', help='Specify loading file path of Learned Segmentation Model')
    ap.add_argument('--model_ndn', '-md', nargs='?', default='models/p128/learned_ndn.npz', help='Specify loading file path of Learned Detection Model')
